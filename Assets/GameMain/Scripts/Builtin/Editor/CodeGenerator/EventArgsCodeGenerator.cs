...
namespace GeminiLion.Editor
{
    ...
    public class EventArgsCodeGenerator : EditorWindow
    {
        ...
        [MenuItem("GeminiLion/Code Generator/EventArgs")]
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField(m_IsHotfixEvent ? GeminiLionSetting.Instance.HotfixEventCodePath : GeminiLionSetting.Instance.EventCodePath);
            EditorGUILayout.EndHorizontal();
        ...
        {
            //根据是否为热更新层事件来决定一些参数
            string codePath = m_IsHotfixEvent ? GeminiLionSetting.Instance.HotfixEventCodePath : GeminiLionSetting.Instance.EventCodePath;
            string nameSpace = m_IsHotfixEvent ? GeminiLionSetting.Instance.HotfixNameSpace : GeminiLionSetting.Instance.NameSpace;
