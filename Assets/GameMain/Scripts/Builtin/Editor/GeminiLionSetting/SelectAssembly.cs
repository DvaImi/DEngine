...
namespace GeminiLion.Editor
{
    public class SelectAssembly : OdinEditorWindow
    {
        ...
        {
            GeminiLionSettingEditorWindows windows = GetWindow<GeminiLionSettingEditorWindows>();
        ...
        private void RefreshListData()
        {
            ...
            HashSet<string> aotDllNames = new HashSet<string>(GeminiLionSetting.Instance.AOTDllNames.Select(item => item.Replace(".dll", null)));
