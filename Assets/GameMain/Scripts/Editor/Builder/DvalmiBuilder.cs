...
{
    public class DvalmiBuilder : EditorWindow
    {
        ...
        [MenuItem("Dvalmi/Builder", false, 0)]
        private static void Open()
        {
            DvalmiBuilder window = GetWindow<DvalmiBuilder>("Builder", true);
        ...
        private void BuildPlayer()
        {
            ...
            //默认构建当前打开的场景
            buildPlayerOptions.locationPathName = Path.Combine(DvalmiSetting.Instance.PublishAppOutput, Application.productName + ".exe");
            buildPlayerOptions.target = m_HybridClrBuilderController.GetBuildTarget(m_HotfixPlatformIndex);
