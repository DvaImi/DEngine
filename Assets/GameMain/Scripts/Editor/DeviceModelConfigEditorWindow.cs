...
namespace JuvenileGemini.Editor
{
    public class DeviceModelConfigEditorWindow : EditorWindow
    {
        ...
        private const string m_Path = "Assets/GameMain/Configs/DeviceModelConfig.asset";

        [MenuItem("JuvenileGemini/CreateAsset DeviceModelConfig")]
        public static void SaveAssets()
        {
            DeviceModelConfig dmc = ScriptableObject.CreateInstance<DeviceModelConfig>();
            AssetDatabase.CreateAsset(dmc, m_Path);
            AssetDatabase.SaveAssets();
            EditorGUIUtility.PingObject(dmc);
            Selection.activeObject = dmc;
        }

        [MenuItem("JuvenileGemini/Device Model Config Editor")]
        public static void EditDeviceModelConfig()
        {
            OpenWindow(AssetDatabase.LoadAssetAtPath<DeviceModelConfig>(m_Path));
        }
        ...
        public static void OpenWindow(DeviceModelConfig deviceModelConfig)
        {
            ...
            AssetDatabase.LoadAssetAtPath<DeviceModelConfig>(m_Path);
