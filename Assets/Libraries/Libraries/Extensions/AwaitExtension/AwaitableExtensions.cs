...
namespace GeminiLion.Await
{
    public static partial class AwaitableExtensions
    {
        private static readonly Dictionary<int, UniTaskCompletionSource<UIForm>> s_UIFormTcs = new Dictionary<int, UniTaskCompletionSource<UIForm>>();

        private static readonly Dictionary<int, UniTaskCompletionSource<Entity>> s_EntityTcs = new Dictionary<int, UniTaskCompletionSource<Entity>>();

        private static readonly Dictionary<string, UniTaskCompletionSource<bool>> s_LoadSceneTcs = new Dictionary<string, UniTaskCompletionSource<bool>>();

        private static readonly Dictionary<string, UniTaskCompletionSource<bool>> s_UnLoadSceneTcs = new Dictionary<string, UniTaskCompletionSource<bool>>();
        ...
        private static void OnOpenUIFormSuccess(object sender, GameEventArgs e)
        {
            ...
            s_UIFormTcs.TryGetValue(ne.UIForm.SerialId, out UniTaskCompletionSource<UIForm> tcs);
            if (tcs != null)
            {
        ...
        private static void OnOpenUIFormFailure(object sender, GameEventArgs e)
        {
            ...
            s_UIFormTcs.TryGetValue(ne.SerialId, out UniTaskCompletionSource<UIForm> tcs);
            if (tcs != null)
            {
