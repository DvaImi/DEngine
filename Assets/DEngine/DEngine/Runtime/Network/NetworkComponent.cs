...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/Network")]
    public sealed class NetworkComponent : DEngineComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_NetworkManager = DEngineEntry.GetModule<INetworkManager>();
        ...
        private void OnNetworkConnected(object sender, DEngine.Network.NetworkConnectedEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkConnectedEventArgs.Create(e));
        }

        private void OnNetworkClosed(object sender, DEngine.Network.NetworkClosedEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkClosedEventArgs.Create(e));
        }

        private void OnNetworkMissHeartBeat(object sender, DEngine.Network.NetworkMissHeartBeatEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkMissHeartBeatEventArgs.Create(e));
        }

        private void OnNetworkError(object sender, DEngine.Network.NetworkErrorEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkErrorEventArgs.Create(e));
        }

        private void OnNetworkCustomError(object sender, DEngine.Network.NetworkCustomErrorEventArgs e)
        {
