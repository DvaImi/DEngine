...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/Entity")]
    public sealed partial class EntityComponent : DEngineComponent
    {
        ...
        [SerializeField]
        private string m_EntityHelperTypeName = "DEngineEntry.Runtime.DefaultEntityHelper";

        [SerializeField]
        private EntityHelperBase m_CustomEntityHelper = null;

        [SerializeField]
        private string m_EntityGroupHelperTypeName = "DEngineEntry.Runtime.DefaultEntityGroupHelper";
        ...
        protected override void Awake()
        {
            ...
            m_EntityManager = DEngineEntry.GetModule<IEntityManager>();
        ...
        private void Start()
        {
            ...
            {
                m_EntityManager.SetResourceManager(DEngineEntry.GetModule<IResourceManager>());
            }

            m_EntityManager.SetObjectPoolManager(DEngineEntry.GetModule<IObjectPoolManager>());
        ...
        private void OnShowEntitySuccess(object sender, DEngine.Entity.ShowEntitySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntitySuccessEventArgs.Create(e));
        }

        private void OnShowEntityFailure(object sender, DEngine.Entity.ShowEntityFailureEventArgs e)
        {
        ...
        private void OnShowEntityUpdate(object sender, DEngine.Entity.ShowEntityUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntityUpdateEventArgs.Create(e));
        }

        private void OnShowEntityDependencyAsset(object sender, DEngine.Entity.ShowEntityDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntityDependencyAssetEventArgs.Create(e));
        }

        private void OnHideEntityComplete(object sender, DEngine.Entity.HideEntityCompleteEventArgs e)
        {
