...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/Config")]
    public sealed class ConfigComponent : DEngineComponent
    {
        ...
        [SerializeField]
        private string m_ConfigHelperTypeName = "DEngine.Runtime.DefaultConfigHelper";
        ...
        protected override void Awake()
        {
            ...
            m_ConfigManager = DEngineEntry.GetModule<IConfigManager>();
        ...
        private void Start()
        {
            ...
            {
                m_ConfigManager.SetResourceManager(DEngineEntry.GetModule<IResourceManager>());
            }
