...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/Resource")]
    public sealed class ResourceComponent : DEngineComponent
    {
        ...
        [SerializeField]
        private string m_ResourceHelperTypeName = "DEngine.Runtime.DefaultResourceHelper";

        [SerializeField]
        private ResourceHelperBase m_CustomResourceHelper = null;

        [SerializeField]
        private string m_LoadResourceAgentHelperTypeName = "DEngine.Runtime.DefaultLoadResourceAgentHelper";
        ...
        private void Start()
        {
            ...
            m_ResourceManager = m_EditorResourceMode ? baseComponent.EditorResourceHelper : DEngineEntry.GetModule<IResourceManager>();
            ...
            m_ResourceManager.SetObjectPoolManager(DEngineEntry.GetModule<IObjectPoolManager>());
            m_ResourceManager.SetFileSystemManager(DEngineEntry.GetModule<IFileSystemManager>());
            m_ResourceManager.SetDownloadManager(DEngineEntry.GetModule<IDownloadManager>());
        ...
        private void OnResourceVerifyStart(object sender, DEngine.Resource.ResourceVerifyStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifyStartEventArgs.Create(e));
        }

        private void OnResourceVerifySuccess(object sender, DEngine.Resource.ResourceVerifySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifySuccessEventArgs.Create(e));
        }

        private void OnResourceVerifyFailure(object sender, DEngine.Resource.ResourceVerifyFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifyFailureEventArgs.Create(e));
        }

        private void OnResourceApplyStart(object sender, DEngine.Resource.ResourceApplyStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplyStartEventArgs.Create(e));
        }

        private void OnResourceApplySuccess(object sender, DEngine.Resource.ResourceApplySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplySuccessEventArgs.Create(e));
        }

        private void OnResourceApplyFailure(object sender, DEngine.Resource.ResourceApplyFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplyFailureEventArgs.Create(e));
        }

        private void OnResourceUpdateStart(object sender, DEngine.Resource.ResourceUpdateStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateStartEventArgs.Create(e));
        }

        private void OnResourceUpdateChanged(object sender, DEngine.Resource.ResourceUpdateChangedEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateChangedEventArgs.Create(e));
        }

        private void OnResourceUpdateSuccess(object sender, DEngine.Resource.ResourceUpdateSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateSuccessEventArgs.Create(e));
        }

        private void OnResourceUpdateFailure(object sender, DEngine.Resource.ResourceUpdateFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateFailureEventArgs.Create(e));
        }

        private void OnResourceUpdateAllComplete(object sender, DEngine.Resource.ResourceUpdateAllCompleteEventArgs e)
        {
