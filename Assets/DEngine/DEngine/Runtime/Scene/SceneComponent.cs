...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/Scene")]
    public sealed class SceneComponent : DEngineComponent
    {
        ...
        private UnityEngine.SceneManagement.Scene m_DEngineScene = default(UnityEngine.SceneManagement.Scene);
        ...
        protected override void Awake()
        {
            ...
            m_SceneManager = DEngineEntry.GetModule<ISceneManager>();
        ...
        private void Start()
        {
            ...
            {
                m_SceneManager.SetResourceManager(DEngineEntry.GetModule<IResourceManager>());
            }
        }
        ...
        private void OnLoadSceneUpdate(object sender, DEngine.Scene.LoadSceneUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, LoadSceneUpdateEventArgs.Create(e));
        }

        private void OnLoadSceneDependencyAsset(object sender, DEngine.Scene.LoadSceneDependencyAssetEventArgs e)
        {
