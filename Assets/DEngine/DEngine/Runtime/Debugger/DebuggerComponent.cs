...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/Debugger")]
    public sealed partial class DebuggerComponent : DEngineComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_DebuggerManager = DEngineEntry.GetModule<IDebuggerManager>();
        ...
        private void OnGUI()
        {
            ...
            if (m_ShowFullWindow)
            {
                m_WindowRect = GUILayout.Window(0, m_WindowRect, DrawWindow, "<b>DENGINE DEBUGGER</b>");
            }
            else
            {
