...
namespace DEngine.UI
{
    ...
    internal sealed partial class UIManager : DEngineModule, IUIManager
    {
        ...
        public bool HasUIGroup(string uiGroupName)
        {
            ...
            {
                throw new DEngineException("UI group name is invalid.");
            }
        ...
        public bool AddUIGroup(string uiGroupName, int uiGroupDepth, IUIGroupHelper uiGroupHelper)
        {
            ...
            {
                throw new DEngineException("UI group helper is invalid.");
            }
        ...
        public bool HasUIForm(string uiFormAssetName)
        {
            ...
            {
                throw new DEngineException("UI form asset name is invalid.");
            }
        ...
        public int OpenUIForm(string uiFormAssetName, string uiGroupName, int priority, bool pauseCoveredUIForm, object userData)
        {
            ...
            {
                throw new DEngineException("You must set UI form helper first.");
            }
            ...
            if (uiGroup == null)
            {
                throw new DEngineException(Utility.Text.Format("UI group '{0}' is not exist.", uiGroupName));
            }
        ...
        public void CloseUIForm(int serialId, object userData)
        {
            ...
            if (uiForm == null)
            {
                throw new DEngineException(Utility.Text.Format("Can not find UI form '{0}'.", serialId));
            }
        ...
        public void CloseUIForm(IUIForm uiForm, object userData)
        {
            if (uiForm == null)
            {
                throw new DEngineException("UI form is invalid.");
            }

            UIGroup uiGroup = (UIGroup)uiForm.UIGroup;
            if (uiGroup == null)
            {
                throw new DEngineException("UI group is invalid.");
            }
        ...
        public void SetUIFormInstanceLocked(object uiFormInstance, bool locked)
        {
            ...
            {
                throw new DEngineException("UI form instance is invalid.");
            }
        ...
        private void InternalOpenUIForm(int serialId, string uiFormAssetName, UIGroup uiGroup, object uiFormInstance, bool pauseCoveredUIForm, bool isNewInstance, float duration, object userData)
        {
            try
            {
                ...
                if (uiForm == null)
                {
                    throw new DEngineException("Can not create UI form in UI form helper.");
                }
        ...
        private void LoadAssetSuccessCallback(string uiFormAssetName, object uiFormAsset, float duration, object userData)
        {
            ...
            {
                throw new DEngineException("Open UI form info is invalid.");
            }
