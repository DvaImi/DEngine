...
namespace DEngine.Network
{
    internal sealed partial class NetworkManager : DEngineModule, INetworkManager
    {
        ...
        private abstract class NetworkChannelBase : INetworkChannel, IDisposable
        {
            ...
            public DEngineAction<NetworkChannelBase, object> NetworkChannelConnected;
            public DEngineAction<NetworkChannelBase> NetworkChannelClosed;
            public DEngineAction<NetworkChannelBase, int> NetworkChannelMissHeartBeat;
            public DEngineAction<NetworkChannelBase, NetworkErrorCode, SocketError, string> NetworkChannelError;
            public DEngineAction<NetworkChannelBase, object> NetworkChannelCustomError;
            ...
            public void RegisterHandler(IPacketHandler handler)
            {
                if (handler == null)
                {
                    throw new DEngineException("Packet handler is invalid.");
                }
