...
namespace DEngine
{
    ...
    public sealed class TaskPool<T> where T : TaskBase
    {
        ...
        private readonly DEngineLinkedList<ITaskAgent<T>> m_WorkingAgents;
        private readonly DEngineLinkedList<T> m_WaitingTasks;
        ...
        public TaskPool()
        {
            ...
            m_WorkingAgents = new DEngineLinkedList<ITaskAgent<T>>();
            m_WaitingTasks = new DEngineLinkedList<T>();
            m_Paused = false;
        }
        ...
        public void AddAgent(ITaskAgent<T> agent)
        {
            if (agent == null)
            {
                throw new DEngineException("Task agent is invalid.");
            }
