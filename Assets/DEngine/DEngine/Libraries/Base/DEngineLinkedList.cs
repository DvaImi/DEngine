...
namespace DEngine
{
    ...
    public sealed class DEngineLinkedList<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
    {
        ...
        public void RemoveFirst()
        {
            ...
            if (first == null)
            {
                throw new DEngineException("First is invalid.");
            }
        ...
        public void RemoveLast()
        {
            ...
            if (last == null)
            {
                throw new DEngineException("Last is invalid.");
            }
        ...
        public struct Enumerator : IEnumerator<T>, IEnumerator
        {
            ...
            internal Enumerator(LinkedList<T> linkedList)
            {
                if (linkedList == null)
                {
                    throw new DEngineException("Linked list is invalid.");
                }
