...
namespace DEngine
{
    ...
    public struct DEngineLinkedListRange<T> : IEnumerable<T>, IEnumerable
    {
        ...
        public DEngineLinkedListRange(LinkedListNode<T> first, LinkedListNode<T> terminal)
        {
        ...
        public struct Enumerator : IEnumerator<T>, IEnumerator
        {
            ...
            internal Enumerator(DEngineLinkedListRange<T> range)
            {
                if (!range.IsValid)
                {
                    throw new DEngineException("Range is invalid.");
