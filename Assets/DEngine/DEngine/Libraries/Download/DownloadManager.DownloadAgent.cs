...
namespace DEngine.Download
{
    internal sealed partial class DownloadManager : DEngineModule, IDownloadManager
    {
        /// <summary>
        /// 下载代理。
        /// </summary>
        private sealed class DownloadAgent : ITaskAgent<DownloadTask>, IDisposable
        {
            ...
            public DEngineAction<DownloadAgent> DownloadAgentStart;
            public DEngineAction<DownloadAgent, int> DownloadAgentUpdate;
            public DEngineAction<DownloadAgent, long> DownloadAgentSuccess;
            public DEngineAction<DownloadAgent, string> DownloadAgentFailure;
            ...
            public DownloadAgent(IDownloadAgentHelper downloadAgentHelper)
            {
                ...
                {
                    throw new DEngineException("Download agent helper is invalid.");
                }
            ...
            public StartTaskStatus Start(DownloadTask task)
            {
                if (task == null)
                {
                    throw new DEngineException("Task is invalid.");
                }
            ...
            private void OnDownloadAgentHelperComplete(object sender, DownloadAgentHelperCompleteEventArgs e)
            {
                ...
                {
                    throw new DEngineException("Internal download error.");
                }
