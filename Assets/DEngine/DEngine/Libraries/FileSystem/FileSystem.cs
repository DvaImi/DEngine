...
namespace DEngine.FileSystem
{
    ...
    internal sealed partial class FileSystem : IFileSystem
    {
        ...
        private readonly DEngineMultiDictionary<int, int> m_FreeBlockIndexes;
        ...
        private FileSystem(string fullPath, FileSystemAccess access, FileSystemStream stream)
        {
            ...
            {
                throw new DEngineException("Full path is invalid.");
            }

            if (access == FileSystemAccess.Unspecified)
            {
                throw new DEngineException("Access is invalid.");
            }

            if (stream == null)
            {
                throw new DEngineException("Stream is invalid.");
            }
            ...
            m_FreeBlockIndexes = new DEngineMultiDictionary<int, int>();
        ...
        public static FileSystem Create(string fullPath, FileSystemAccess access, FileSystemStream stream, int maxFileCount, int maxBlockCount)
        {
            if (maxFileCount <= 0)
            {
                throw new DEngineException("Max file count is invalid.");
            }

            if (maxBlockCount <= 0)
            {
                throw new DEngineException("Max block count is invalid.");
            }

            if (maxFileCount > maxBlockCount)
            {
                throw new DEngineException("Max file count can not larger than max block count.");
            }
        ...
        public FileInfo GetFileInfo(string name)
        {
            ...
            {
                throw new DEngineException("Name is invalid.");
            }
        ...
        public byte[] ReadFile(string name)
        {
            ...
            {
                throw new DEngineException("File system is not readable.");
            }
        ...
        public int ReadFile(string name, byte[] buffer, int startIndex, int length)
        {
            ...
            {
                throw new DEngineException("Start index or length is invalid.");
            }
        ...
        public int ReadFile(string name, Stream stream)
        {
            ...
            if (!stream.CanWrite)
            {
                throw new DEngineException("Stream is not writable.");
            }
        ...
        public byte[] ReadFileSegment(string name, int offset, int length)
        {
            ...
            if (offset < 0)
            {
                throw new DEngineException("Index is invalid.");
            }

            if (length < 0)
            {
                throw new DEngineException("Length is invalid.");
            }
        ...
        public bool WriteFile(string name, byte[] buffer, int startIndex, int length)
        {
            ...
            {
                throw new DEngineException("File system is not writable.");
            }
            ...
            {
                throw new DEngineException(Utility.Text.Format("Name '{0}' is too long.", name));
            }
        ...
        public bool WriteFile(string name, Stream stream)
        {
            ...
            if (!stream.CanRead)
            {
                throw new DEngineException("Stream is not readable.");
            }
        ...
        public bool WriteFile(string name, string filePath)
        {
            ...
            {
                throw new DEngineException("File path is invalid");
            }
        ...
        public bool RenameFile(string oldName, string newName)
        {
            ...
            {
                throw new DEngineException("Old name is invalid.");
            }

            if (string.IsNullOrEmpty(newName))
            {
                throw new DEngineException("New name is invalid.");
            }

            if (newName.Length > byte.MaxValue)
            {
                throw new DEngineException(Utility.Text.Format("New name '{0}' is too long.", newName));
            }
        ...
        private bool TryCombineFreeBlocks(int freeBlockIndex)
        {
            ...
            foreach (KeyValuePair<int, DEngineLinkedListRange<int>> blockIndexes in m_FreeBlockIndexes)
            {
        ...
        {
            DEngineLinkedListRange<int> lengthRange = default(DEngineLinkedListRange<int>);
        ...
        private int AllocBlock(int length)
        {
            ...
            int lengthFound = -1;
            DEngineLinkedListRange<int> lengthRange = default(DEngineLinkedListRange<int>);
            foreach (KeyValuePair<int, DEngineLinkedListRange<int>> i in m_FreeBlockIndexes)
            {
                if (i.Key < length)
                {
                    continue;
