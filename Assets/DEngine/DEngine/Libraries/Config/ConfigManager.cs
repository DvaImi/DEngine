...
namespace DEngine.Config
{
    ...
    /// 全局配置管理器。
    /// </summary>
    internal sealed partial class ConfigManager : DEngineModule, IConfigManager
    {
        ...
        public void SetConfigHelper(IConfigHelper configHelper)
        {
            ...
            {
                throw new DEngineException("Config helper is invalid.");
            }
        ...
        public bool GetBool(string configName)
        {
            ...
            {
                throw new DEngineException(Utility.Text.Format("Config name '{0}' is not exist.", configName));
            }
        ...
        private ConfigData? GetConfigData(string configName)
        {
            ...
            {
                throw new DEngineException("Config name is invalid.");
            }
