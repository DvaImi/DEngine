...
namespace DEngine.Localization
{
    /// <summary>
    /// 本地化管理器。
    /// </summary>
    internal sealed partial class LocalizationManager : DEngineModule, ILocalizationManager
    {
        ...
        public Language Language
        {
            ...
            set
            {
                ...
                {
                    throw new DEngineException("Language is invalid.");
                }
        ...
        public Language SystemLanguage
        {
            get
            {
                ...
                {
                    throw new DEngineException("You must set localization helper first.");
                }
        ...
        public void SetLocalizationHelper(ILocalizationHelper localizationHelper)
        {
            ...
            {
                throw new DEngineException("Localization helper is invalid.");
            }
        ...
        public bool HasRawString(string key)
        {
            ...
            {
                throw new DEngineException("Key is invalid.");
            }
