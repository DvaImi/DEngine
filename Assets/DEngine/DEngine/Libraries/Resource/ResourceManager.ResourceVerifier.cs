...
namespace DEngine.Resource
{
    internal sealed partial class ResourceManager : DEngineModule, IResourceManager
    {
        ...
        private sealed partial class ResourceVerifier
        {
            ...
            public DEngineAction<int, long> ResourceVerifyStart;
            public DEngineAction<ResourceName, int> ResourceVerifySuccess;
            public DEngineAction<ResourceName> ResourceVerifyFailure;
            public DEngineAction<bool> ResourceVerifyComplete;
            ...
            public void VerifyResources(int verifyResourceLengthPerFrame)
            {
                ...
                {
                    throw new DEngineException("Verify resource count per frame is invalid.");
                }
