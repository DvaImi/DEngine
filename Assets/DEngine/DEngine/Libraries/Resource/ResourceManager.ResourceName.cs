    ...
    internal sealed partial class ResourceManager : DEngineModule, IResourceManager
    {
        ...
        private struct ResourceName : IComparable, IComparable<ResourceName>, IEquatable<ResourceName>
        {
            ...
            public ResourceName(string name, string variant, string extension)
            {
                ...
                {
                    throw new DEngineException("Resource name is invalid.");
                }

                if (string.IsNullOrEmpty(extension))
                {
                    throw new DEngineException("Resource extension is invalid.");
                }
            ...
            public int CompareTo(object value)
            {
                ...
                {
                    throw new DEngineException("Type of value is invalid.");
                }
