...
{
    internal sealed partial class WebRequestManager : DEngineModule, IWebRequestManager
    {
        /// <summary>
        /// Web 请求代理。
        /// </summary>
        private sealed class WebRequestAgent : ITaskAgent<WebRequestTask>
        {
            ...
            public DEngineAction<WebRequestAgent> WebRequestAgentStart;
            public DEngineAction<WebRequestAgent, byte[]> WebRequestAgentSuccess;
            public DEngineAction<WebRequestAgent, string> WebRequestAgentFailure;
            ...
            public WebRequestAgent(IWebRequestAgentHelper webRequestAgentHelper)
            {
                ...
                {
                    throw new DEngineException("Web request agent helper is invalid.");
                }
