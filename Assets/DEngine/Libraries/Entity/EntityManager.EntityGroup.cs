...
namespace DEngine.Entity
{
    internal sealed partial class EntityManager : DEngineModule, IEntityManager
    {
        ...
        private sealed class EntityGroup : IEntityGroup
        {
            ...
            private readonly DEngineLinkedList<IEntity> m_Entities;
            ...
            public EntityGroup(string name, float instanceAutoReleaseInterval, int instanceCapacity, float instanceExpireTime, int instancePriority, IEntityGroupHelper entityGroupHelper, IObjectPoolManager objectPoolManager)
            {
                ...
                m_Entities = new DEngineLinkedList<IEntity>();
                m_CachedNode = null;
            }
            ...
            public void RemoveEntity(IEntity entity)
            {
                ...
                {
                    throw new DEngineException(Utility.Text.Format("Entity group '{0}' not exists specified entity '[{1}]{2}'.", m_Name, entity.Id, entity.EntityAssetName));
                }
            }
            ...
            public void SetEntityInstanceLocked(object entityInstance, bool locked)
            {
                ...
                {
                    throw new DEngineException("Entity instance is invalid.");
                }
