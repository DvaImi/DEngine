...
namespace DEngine.Network
{
    ...
    internal sealed partial class NetworkManager : DEngineModule, INetworkManager
    {
        ...
        public INetworkChannel CreateNetworkChannel(string name, ServiceType serviceType, INetworkChannelHelper networkChannelHelper)
        {
            ...
            {
                throw new DEngineException("Network channel helper is invalid.");
            }

            if (networkChannelHelper.PacketHeaderLength < 0)
            {
                throw new DEngineException("Packet header length is invalid.");
            }
            ...
            switch (serviceType)
            {
                ...
                default:
                    throw new DEngineException(Utility.Text.Format("Not supported service type '{0}'.", serviceType));
            }
