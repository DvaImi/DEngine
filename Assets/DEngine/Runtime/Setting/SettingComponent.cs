...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/Setting")]
    public sealed class SettingComponent : DEngineComponent
    {
        private ISettingManager m_SettingManager = null;

        [SerializeField]
        private string m_SettingHelperTypeName = "DEngine.Runtime.DefaultSettingHelper";
        ...
        protected override void Awake()
        {
            ...
            m_SettingManager = DEngineEntry.GetModule<ISettingManager>();
