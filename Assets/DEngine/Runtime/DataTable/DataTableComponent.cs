...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/Data Table")]
    public sealed class DataTableComponent : DEngineComponent
    {
        ...
        [SerializeField]
        private string m_DataTableHelperTypeName = "DEngine.Runtime.DefaultDataTableHelper";
        ...
        private void Start()
        {
            ...
            {
                m_DataTableManager.SetResourceManager(DEngineEntry.GetModule<IResourceManager>());
            }
