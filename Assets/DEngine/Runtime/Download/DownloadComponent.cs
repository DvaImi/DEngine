...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/Download")]
    public sealed class DownloadComponent : DEngineComponent
    {
        ...
        [SerializeField]
        private string m_DownloadAgentHelperTypeName = "DEngine.Runtime.UnityWebRequestDownloadAgentHelper";
        ...
        protected override void Awake()
        {
            ...
            m_DownloadManager = DEngineEntry.GetModule<IDownloadManager>();
        ...
        private void OnDownloadStart(object sender, DEngine.Download.DownloadStartEventArgs e)
        {
            m_EventComponent.Fire(this, DownloadStartEventArgs.Create(e));
        }

        private void OnDownloadUpdate(object sender, DEngine.Download.DownloadUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, DownloadUpdateEventArgs.Create(e));
        }

        private void OnDownloadSuccess(object sender, DEngine.Download.DownloadSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, DownloadSuccessEventArgs.Create(e));
        }

        private void OnDownloadFailure(object sender, DEngine.Download.DownloadFailureEventArgs e)
        {
