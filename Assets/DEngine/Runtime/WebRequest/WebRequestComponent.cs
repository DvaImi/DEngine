...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/Web Request")]
    public sealed class WebRequestComponent : DEngineComponent
    {
        ...
        [SerializeField]
        private string m_WebRequestAgentHelperTypeName = "DEngine.Runtime.UnityWebRequestAgentHelper";
        ...
        protected override void Awake()
        {
            ...
            m_WebRequestManager = DEngineEntry.GetModule<IWebRequestManager>();
        ...
        private void OnWebRequestStart(object sender, DEngine.WebRequest.WebRequestStartEventArgs e)
        {
            m_EventComponent.Fire(this, WebRequestStartEventArgs.Create(e));
        }

        private void OnWebRequestSuccess(object sender, DEngine.WebRequest.WebRequestSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, WebRequestSuccessEventArgs.Create(e));
        }

        private void OnWebRequestFailure(object sender, DEngine.WebRequest.WebRequestFailureEventArgs e)
        {
