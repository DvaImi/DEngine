...
{
    public static class SpecificationInResourceName
    {
        ...
        public static void CheckResourcesName(string[] folderPaths)
        {
        ...
        public static void RenameResource(string[] folderPaths)
        {
            bool invalid = folderPaths == null || folderPaths.Length == 0;
            foreach (var folderPath in folderPaths)
            {
