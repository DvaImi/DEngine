...
namespace Game.Editor.DataTableTools
{
    public class DataTableSettingEditorWindows : OdinEditorWindow
    {
        ...
        private void ReadSetting()
        {
            ...
            LocalizationPath = DataTableSetting.Instance.LocalizationPath;
            LocalizationExcelsFolder = DataTableSetting.Instance.LocalizationExcelsFolder;

            ConfigPath = DataTableSetting.Instance.ConfigPath;
            ConfigExcelsFolder = DataTableSetting.Instance.ConfigExcelsFolder;
        }
        ...
        private void SaveSetting()
        {
            ...
            DataTableSetting.Instance.LocalizationPath = LocalizationPath;
            DataTableSetting.Instance.LocalizationExcelsFolder = LocalizationExcelsFolder;
            DataTableSetting.Instance.ConfigPath = ConfigPath;
            DataTableSetting.Instance.ConfigExcelsFolder = ConfigExcelsFolder;
