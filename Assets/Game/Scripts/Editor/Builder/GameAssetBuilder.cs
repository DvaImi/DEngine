...
namespace Game.Editor.ResourceTools
{
    ...
    public static class GameAssetBuilder
    {
        ...
        public static void BuildBundle(Platform platform, string outputDirectory, GameFrameworkAction complete = null)
        {
            m_Controller = new ResourceBuilderController();
            m_Controller.OnLoadingResource += OnLoadingResource;
            m_Controller.OnLoadingAsset += OnLoadingAsset;
            ...
            if (m_Controller.Load())
            {
                ...
                m_Controller.BuildEventHandlerTypeName = typeof(GameBuildEventHandler).FullName;
                m_Controller.RefreshBuildEventHandler();
            }
            else
            {
        ...
        public static BuildReport BuildApplication(BuildTarget platform)
        {
            ...
            BuildPlayerOptions buildPlayerOptions = new()
            {
                ...
                locationPathName = Path.Combine(GameSetting.Instance.AppOutput, PlatformNames[GameSetting.Instance.BuildPlatform], Application.productName + outputExtension),
                target = platform,
