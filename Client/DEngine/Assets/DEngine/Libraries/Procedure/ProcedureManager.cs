...
namespace DEngine.Procedure
{
    /// <summary>
    /// 流程管理器。
    /// </summary>
    internal sealed class ProcedureManager : DEngineModule, IProcedureManager
    {
        ...
        public ProcedureBase CurrentProcedure
        {
            get
            {
                ...
                {
                    throw new DEngineException("You must initialize procedure first.");
                }
        ...
        public void Initialize(IFsmManager fsmManager, params ProcedureBase[] procedures)
        {
            if (fsmManager == null)
            {
                throw new DEngineException("FSM manager is invalid.");
            }
