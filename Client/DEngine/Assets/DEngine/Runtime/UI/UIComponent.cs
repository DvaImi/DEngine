...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/UI")]
    public sealed partial class UIComponent : DEngineComponent
    {
        ...
        [SerializeField]
        private string m_UIFormHelperTypeName = "DEngine.Runtime.DefaultUIFormHelper";

        [SerializeField]
        private UIFormHelperBase m_CustomUIFormHelper = null;

        [SerializeField]
        private string m_UIGroupHelperTypeName = "DEngine.Runtime.DefaultUIGroupHelper";
        ...
        protected override void Awake()
        {
            ...
            m_UIManager = DEngineEntry.GetModule<IUIManager>();
            if (m_UIManager == null)
            {
        ...
        private void Start()
        {
            ...
            {
                m_UIManager.SetResourceManager(DEngineEntry.GetModule<IResourceManager>());
            }

            m_UIManager.SetObjectPoolManager(DEngineEntry.GetModule<IObjectPoolManager>());
        ...
        private void OnOpenUIFormSuccess(object sender, DEngine.UI.OpenUIFormSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, OpenUIFormSuccessEventArgs.Create(e));
        }

        private void OnOpenUIFormFailure(object sender, DEngine.UI.OpenUIFormFailureEventArgs e)
        {
        ...
        private void OnOpenUIFormUpdate(object sender, DEngine.UI.OpenUIFormUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, OpenUIFormUpdateEventArgs.Create(e));
        }

        private void OnOpenUIFormDependencyAsset(object sender, DEngine.UI.OpenUIFormDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, OpenUIFormDependencyAssetEventArgs.Create(e));
        }

        private void OnCloseUIFormComplete(object sender, DEngine.UI.CloseUIFormCompleteEventArgs e)
        {
