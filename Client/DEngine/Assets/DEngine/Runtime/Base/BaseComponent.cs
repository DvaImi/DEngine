...
namespace DEngine.Runtime
{
    ...
    public sealed class BaseComponent : DEngineComponent
    {
        ...
        [SerializeField]
        private string m_TextHelperTypeName = "DEngine.Runtime.DefaultTextHelper";

        [SerializeField]
        private string m_VersionHelperTypeName = "DEngine.Runtime.DefaultVersionHelper";

        [SerializeField]
        private string m_LogHelperTypeName = "DEngine.Runtime.DefaultLogHelper";

        [SerializeField]
        private string m_CompressionHelperTypeName = "DEngine.Runtime.DefaultCompressionHelper";

        [SerializeField]
        private string m_JsonHelperTypeName = "DEngine.Runtime.DefaultJsonHelper";
