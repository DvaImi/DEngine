...
namespace DEngine.Editor.ResourceTools
{
    public sealed partial class ResourceBuilderController
    {
        private sealed class BuildReport
        {
            ...
            private int m_LastFullBuildVersion;
            ...
            public void SaveReport()
            {
                ...
                XmlElement xmlElement = xmlDocument.CreateElement("ProductName");
                ...
                xmlSummary.AppendChild(xmlElement);
                xmlElement = xmlDocument.CreateElement("LastFullBuildVersion");
                xmlElement.InnerText = m_LastFullBuildVersion.ToString();
                xmlSummary.AppendChild(xmlElement);
            ...
            /// 差异化打包需要关注上次构建整包的版本
            /// </summary>
            /// <param name="lastFullBuildVersion"></param>
            public void ReportLastFullBuildVersion(int lastFullBuildVersion)
            {
                m_LastFullBuildVersion = lastFullBuildVersion;
            }
            ...
            /// <param name="buildReportPath"></param>
            /// <returns></returns>
            public bool GetResourceDatasFromLastReport(Platform platform, string buildReportPath)
            {
                ...
                try
                {
                    ...
                    ReportLastFullBuildVersion(int.Parse(xmlLastFullBuildVersion.InnerText));
            ...
            /// 获取资产数据
            /// </summary>
            /// <param name="xmlNdoe"></param>
            /// <param name="guid"></param>
            /// <param name="name"></param>
            /// <param name="length"></param>
            /// <param name="hashCode"></param>
            /// <param name="metaLength"></param>
            /// <param name="metaHashCode"></param>
            ...
            /// 获取差异文件
            /// </summary>
            /// <param name="resourceDatas"></param>
            /// <returns></returns>
                        ...
                        foreach (var curr in resource.GetAssetDatas())
                        {
                            ...
                            foreach (var last in resourceData.GetAssetDatas())
                            {
                                if (last.Name == curr.Name)
                                {
                                    existsAsset = true;
                                    //判断资源变化
                                    if (last.HashCode != curr.HashCode || last.MetaLength != curr.MetaLength || last.MetaHashCode != curr.MetaHashCode)
                                    {
                                        return true;
                                    }
                                }
