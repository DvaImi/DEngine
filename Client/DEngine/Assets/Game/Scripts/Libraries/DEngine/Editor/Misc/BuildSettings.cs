...
namespace DEngine.Editor
{
    ...
    public static class BuildSettings
    {
        ...
        {
            s_ConfigurationPath = DEngineType.GetConfigurationPath<BuildSettingsConfigPathAttribute>() ?? Utility.Path.GetRegularPath(Path.Combine(Application.dataPath, "DEngine/Configs/BuildSettings.xml"));
        ...
        /// 将构建场景设置为默认。
        /// </summary>
        [MenuItem("DEngine/Scenes in Build Settings/Default Scenes", false, 20)]
        ...
        /// 将构建场景设置为所有。
        /// </summary>
        [MenuItem("DEngine/Scenes in Build Settings/All Scenes", false, 21)]
