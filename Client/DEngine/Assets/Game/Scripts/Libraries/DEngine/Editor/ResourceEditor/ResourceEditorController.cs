...
namespace DEngine.Editor.ResourceTools
{
    public sealed class ResourceEditorController
    {
        ...
        {
            m_ConfigurationPath = DEngineType.GetConfigurationPath<ResourceEditorConfigPathAttribute>() ?? Utility.Path.GetRegularPath(Path.Combine(Application.dataPath, "DEngine/Configs/ResourceEditor.xml"));
        ...
        public event DEngineAction<SourceAsset[]> OnAssetAssigned = null;

        public event DEngineAction<SourceAsset[]> OnAssetUnassigned = null;
