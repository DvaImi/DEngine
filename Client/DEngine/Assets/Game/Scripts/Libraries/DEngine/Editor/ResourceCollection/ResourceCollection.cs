...
namespace DEngine.Editor.ResourceTools
{
    ...
    public sealed class ResourceCollection
    {
        ...
        {
            m_ConfigurationPath = DEngineType.GetConfigurationPath<ResourceCollectionConfigPathAttribute>() ?? Utility.Path.GetRegularPath(Path.Combine(Application.dataPath, "DEngine/Configs/ResourceCollection.xml"));
