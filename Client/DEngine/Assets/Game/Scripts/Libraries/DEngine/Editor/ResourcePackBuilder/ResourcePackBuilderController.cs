...
namespace DEngine.Editor.ResourceTools
{
    ...
    {
        private const string DefaultResourcePackName = "ResourcePack";
        ...
        public event DEngineAction<int> OnBuildResourcePacksStarted = null;

        public event DEngineAction<int, int> OnBuildResourcePacksCompleted = null;

        public event DEngineAction<int, int, string, string> OnBuildResourcePackSuccess = null;

        public event DEngineAction<int, int, string, string> OnBuildResourcePackFailure = null;
        ...
        public string[] GetVersionNames()
        {
            ...
            foreach (DirectoryInfo directoryInfo in sourceDirectoryInfo.GetDirectories())
            {
                ...
                FileInfo[] versionListFiles = platformDirectoryInfo.GetFiles("RemoteVersionList.*.version", SearchOption.TopDirectoryOnly);
        ...
        public bool BuildResourcePack(string sourceVersion, string targetVersion)
        {
            try
            {
                ...
                if (sourceVersion != null)
                {
                    ...
                    FileInfo[] sourceVersionListFiles = sourceDirectoryInfo.GetFiles("RemoteVersionList.*.version", SearchOption.TopDirectoryOnly);
                ...
                FileInfo[] targetVersionListFiles = targetDirectoryInfo.GetFiles("RemoteVersionList.*.version", SearchOption.TopDirectoryOnly);
