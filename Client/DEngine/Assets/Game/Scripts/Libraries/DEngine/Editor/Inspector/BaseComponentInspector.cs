...
namespace DEngine.Editor
{
    ...
    internal sealed class BaseComponentInspector : DEngineInspector
    {
        ...
        private SerializedProperty m_VariantHelperTypeName = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                {
                    EditorGUILayout.HelpBox("Editor resource mode option is only for editor mode. DEngine will use editor resource files, which you should validate first.", MessageType.Warning);
            ...
            int frameRate = EditorGUILayout.IntSlider("Frame Rate", m_FrameRate.intValue, 1, 144);
        ...
        private void OnEnable()
        {
            ...
            m_VariantHelperTypeName = serializedObject.FindProperty("m_VariantHelperTypeName");
        ...
        private void RefreshTypeNames()
        {
            ...
            textHelperTypeNames.AddRange(DEngineType.GetRuntimeTypeNames(typeof(Utility.Text.ITextHelper)));
            ...
            versionHelperTypeNames.AddRange(DEngineType.GetRuntimeTypeNames(typeof(Version.IVersionHelper)));
            ...
            logHelperTypeNames.AddRange(DEngineType.GetRuntimeTypeNames(typeof(DEngineLog.ILogHelper)));
            ...
            compressionHelperTypeNames.AddRange(DEngineType.GetRuntimeTypeNames(typeof(Utility.Compression.ICompressionHelper)));
            ...
            jsonHelperTypeNames.AddRange(DEngineType.GetRuntimeTypeNames(typeof(Utility.Json.IJsonHelper)));
