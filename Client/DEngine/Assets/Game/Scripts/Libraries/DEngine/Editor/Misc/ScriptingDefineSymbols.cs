...
namespace DEngine.Editor
{
    ...
    public static class ScriptingDefineSymbols
    {
        ...
        public static string[] GetScriptingDefineSymbols(BuildTargetGroup buildTargetGroup)
        {
            ...
            return PlayerSettings.GetScriptingDefineSymbols(UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(buildTargetGroup)).Split(';');
#else
        ...
        {
#if UNITY_6000_0_OR_NEWER
            PlayerSettings.SetScriptingDefineSymbols(UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(buildTargetGroup), scriptingDefineSymbols);
#else
