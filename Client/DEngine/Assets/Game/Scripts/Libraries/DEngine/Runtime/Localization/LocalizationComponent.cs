...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/Localization")]
    public sealed class LocalizationComponent : DEngineComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_LocalizationManager = DEngineEntry.GetModule<ILocalizationManager>();
        ...
        private void Start()
        {
            ...
            {
                m_LocalizationManager.SetResourceManager(DEngineEntry.GetModule<IResourceManager>());
            }
