...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/Sound")]
    public sealed partial class SoundComponent : DEngineComponent
    {
        ...
        [SerializeField]
        private string m_SoundHelperTypeName = "UnityDEngine.Runtime.DefaultSoundHelper";

        [SerializeField]
        private SoundHelperBase m_CustomSoundHelper = null;

        [SerializeField]
        private string m_SoundGroupHelperTypeName = "UnityDEngine.Runtime.DefaultSoundGroupHelper";

        [SerializeField]
        private SoundGroupHelperBase m_CustomSoundGroupHelper = null;

        [SerializeField]
        private string m_SoundAgentHelperTypeName = "UnityDEngine.Runtime.DefaultSoundAgentHelper";
        ...
        protected override void Awake()
        {
            ...
            m_SoundManager = DEngineEntry.GetModule<ISoundManager>();
...
#else
            ISceneManager sceneManager = DEngineEntry.GetModule<ISceneManager>();
        ...
        private void Start()
        {
            ...
            {
                m_SoundManager.SetResourceManager(DEngineEntry.GetModule<IResourceManager>());
            }
        ...
        private void OnPlaySoundSuccess(object sender, DEngine.Sound.PlaySoundSuccessEventArgs e)
        {
        ...
        private void OnPlaySoundFailure(object sender, DEngine.Sound.PlaySoundFailureEventArgs e)
        {
        ...
        private void OnPlaySoundUpdate(object sender, DEngine.Sound.PlaySoundUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, PlaySoundUpdateEventArgs.Create(e));
        }

        private void OnPlaySoundDependencyAsset(object sender, DEngine.Sound.PlaySoundDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, PlaySoundDependencyAssetEventArgs.Create(e));
        }

        private void OnLoadSceneSuccess(object sender, DEngine.Scene.LoadSceneSuccessEventArgs e)
        {
            RefreshAudioListener();
        }

        private void OnLoadSceneFailure(object sender, DEngine.Scene.LoadSceneFailureEventArgs e)
        {
            RefreshAudioListener();
        }

        private void OnUnloadSceneSuccess(object sender, DEngine.Scene.UnloadSceneSuccessEventArgs e)
        {
            RefreshAudioListener();
        }

        private void OnUnloadSceneFailure(object sender, DEngine.Scene.UnloadSceneFailureEventArgs e)
        {
            RefreshAudioListener();
        }
        ...
        private void RefreshAudioListener()
        {
            ...
            m_AudioListener.enabled = FindObjectsByType<AudioListener>(FindObjectsInactive.Exclude, FindObjectsSortMode.None).Length <= 1;
#else
