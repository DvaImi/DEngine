...
namespace DEngine.Runtime
{
    ...
    [AddComponentMenu("DEngine/Object Pool")]
    public sealed class ObjectPoolComponent : DEngineComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_ObjectPoolManager = DEngineEntry.GetModule<IObjectPoolManager>();
