...
namespace DEngine.Setting
{
    /// <summary>
    /// 游戏配置管理器。
    /// </summary>
    internal sealed class SettingManager : DEngineModule, ISettingManager
    {
        ...
        public int Count
        {
            get
            {
                ...
                {
                    throw new DEngineException("Setting helper is invalid.");
                }
        ...
        public bool HasSetting(string settingName)
        {
            ...
            {
                throw new DEngineException("Setting name is invalid.");
            }
