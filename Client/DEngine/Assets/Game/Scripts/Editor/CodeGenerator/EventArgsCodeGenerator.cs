...
namespace Game.Editor
{
    ...
    public class EventArgsCodeGenerator : EditorWindow
    {
        ...
        [MenuItem("Game/代码生成器/事件参数类代码生成器")]
        ...
        /// 事件参数数据列表
        /// </summary>
        [SerializeField] private List<EventArgsData> m_EventArgsDatas = new List<EventArgsData>();
        ...
        //事件代码生成后的路径
        private const string EventCodePath = "Assets/Game/Scripts/Runtime/EventArgs";
        ...
        {
            //根据是否为热更新层事件来决定一些参数
            string codePath = Path.Combine(m_IsHotfixEvent ? HotfixEventCodePath : EventCodePath, m_SubDirectory);
            string nameSpace = m_IsHotfixEvent ? "Game.Hotfix" : "Game";
