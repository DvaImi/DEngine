    ...
    public partial class GameDownloadAgentHelper
    {
        private sealed class GameDownloadHandler : DownloadHandlerScript
        {
            ...
            protected override bool ReceiveData(byte[] bytes, int dataLength)
            {
                ...
                {
                    DownloadAgentHelperUpdateBytesEventArgs downloadAgentHelperUpdateBytesEventArgs = DownloadAgentHelperUpdateBytesEventArgs.Create(bytes, 0, dataLength);
                ...
                return base.ReceiveData(bytes, dataLength);
            }
        }
    }
}